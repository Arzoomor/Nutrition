...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js"></script>  
	...
	<body>
		...
		<div class="container">
			...
			<div class="col-md-2">
				<form method="post">
					<div style="border:1px solid #333; background-color:#f1f1f1; border-radius:8px; padding:15px;" align="center">
			...
			<?php echo $message; ?>
			<div align="right">
				<a href="store.php?action=clear"><b>Clear Cart</b></a>
			</div>
			...
			?>
				<tr>
					...
					<td><a href="store.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">RemoveItem</span></a></td>
				</tr>
			<?php	
